    ...
    <div class="max-w-4xl bg-white w-full rounded-lg shadow-xl">
      <div class="p-4 border-b">
        ...
        <p class="text-sm text-gray-500">
          Go to <NuxtLink to="/classes/create" class="font-bold hover:text-black">new class</NuxtLink> to add more class name
        </p>
      </div>
  ...
  async function submitForm() {
    ...
    if (validDOW && validName) {
      ...
      if (data.value) {
        ...
        successAlert.value.message = `A session of ${className.value} has been created.`
